...
<dl class="company_center_aside">
	...
	<dd>
		<a href="${ctx}/position/findposition2?size=0&id=${id}">已下线职位</a>
	</dd>
	</dl>
   ...
   <div class="f24">338167634</div>
            ...
            <div class="content">
            	<dl class="company_center_content">
                    ...
                    <dd>
			           <table style="border:black 1px dashed;width:745px;" cellspacing="0">
							<tr>
								<th style="border:black 1px dashed;">职位名称</th>
								<th style="border:black 1px dashed;">工作城市</th>
								<th style="border:black 1px dashed;">工作经验</th>
							...
							<c:forEach items="${list}" var="p">
								<tr>
									...
									<td style="border:black 1px dashed;" align="center">${p.city }</td>
									<td style="border:black 1px dashed;" align="center">${p.experience }</td>
									<td style="border:black 1px dashed;" align="center"><a href="${ctx }/position/deleteposition?id=${p.id}" text-decoration="none">删除</a></td>
								</tr>
							</c:forEach>
						</table>
                    </dd>
