...
<div id="body">
	<div id="header">
    	<div class="wrapper">
    		<a href="${ctx}/user/index" class="logo">
    ...
    <div id="container">
            ...
            <div class="content_l">
                    ...
                    <dd class="job_request">
                    	<span class="red">${p.minSalary}k-${p.maxSalary}k</span>
                       	<span>${p.city}</span> 
                       	<span>经验${p.experience} </span>
                       	<span> ${p.degree}</span> 
                       	<span>${p.jobNature}</span><br />
                      	  职位诱惑 : 大家都来了 你还在等什么！！
                      	<div>发布时间：3天前发布</div>
                    </dd>
                    <dd class="job_bt">
                        <h3 class="description">职位描述</h3>
                        <p>岗位职责： <br />1、参与管理和维护立方网，保证网络社区健康、有序地运转，负责网站信息安全； <br />2、强化团队建设，提高团队工作效率，做好领导与员工直接沟通的桥梁； <br />3、制定和完善客服体系规章制度,培训新人。 <br />4、${p.description}</p>
<p>&nbsp;岗位要求： <br />1、2年以上互联网行业客服主管工作经验，本科及以上学历； <br />2、良好的沟通和协调能力、人际交往能力和语言表达能力； <br />3、较强的责任心和执行力，富有工作热情和团队协作能力。<br /></p>
                    </dd>
                ...
                <dl class="job_company">
                    <dt>
                    	<a href="${c.url}" target="_blank">
                            <img class="b2" src="${c.image}" width="80" height="80" alt="北京立方网信息技术有限公司" />
                            <div>
                                <h2 class="fl">
                                	                                  		立方网
                                  	                                  	
                                  	                                    	<img src="${ctx}/style/images/valid.png" width="15" height="19" alt="奇迹才聘认证企业" /> 
                    ...
                    <dd>
                    	<ul class="c_feature reset">
                        	<li><span>领域</span> ${c.industryfield}</li>
                        	<li><span>规模</span> ${c.scale }</li>
                        	<li>
                        		<span>主页</span> 
                        		           							<a href="${c.url }" target="_blank" title="" rel="nofollow">${c.url }</a>
           						                        	</li>
                        </ul>
                        
                        <h4>发展阶段</h4>
                        <ul class="c_feature reset">
                        	<li><span>目前阶段</span> ${c.thefinancingstage }</li>
