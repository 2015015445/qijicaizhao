    	...
    	<div class="wrapper">
            ...
            <c:if test="${user != null }">
            	...
            	<dt>
                	...
                	<dd><a href="${ctx }/delivery?pageNum=1&myEmail=${user.email }&type=5">我投递的职位 <span id="noticeNo" class="red">(1)</span></a></dd>
...
<!-- 投递简历时  - 设置默认投递简历 -->
	<div id="setResumeApply" class="popup" style="height:280px;">
	    <table width="100%">
	    	...
	    	<tr>
	        	<td>
                    <form  action="${ctx }/sendresumemail?semail=${user.email }&remail=${jobdetail.email}" method="post">
