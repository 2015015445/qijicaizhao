...
<dl class="company_center_aside">
	...
	<dd>
            ...
            <div class="content">
            	<dl class="company_center_content">
                    <dt>
                        <h1>
                            <em></em>
                            	待定简历  <span>（共${resumereceived.totalCount }份）</span>                        </h1>
                    </dt>
                    <dd>
     ...
     <input type="hidden" value="" name="positionId" id="positionId">
		                        	...
		                        	<c:forEach items="${resume }" var="p" varStatus="loop">
		                        		<li data-id="1686182" class="onlineResume">
			                                ...
			                                <div class="resumeIntro">
			                                    ...
			                                    <div class="links">
			                                        <a data-deliverid="1686182" data-name="jason" data-positionid="149594" data-email="888888888@qq.com" class="resume_notice" href="${ctx }/updateresumerecivedtype?id=${resumereceived.list[loop.count-1].id}&agotype=1&type=2">通知面试</a>
			                                        <a data-deliverid="1686182" class="resume_refuse" href="${ctx }/updateresumerecivedtype?id=${resumereceived.list[loop.count-1].id}&agotype=1&type=3">不合适</a>
			                                   		<a data-resumename="jason的简历" data-positionname="随便写" data-deliverid="1686182" data-positionid="149594" data-resumekey="1ccca806e13637f7b1a4560f80f08057" data-forwardcount="1" class="resume_forward" href="${ctx }/updateresumerecivedtype?id=${resumereceived.list[loop.count-1].id}&agotype=1&type=1">
                                                    	待定</span></a>
			                                    </div>
			                                </div>
			        ...
			        <a href="" class="numstyle1" href="${ctx }/caninterviewresumes?pageNum=1&type=1"><font color="#fff">首页</font></a>
			        ...
			        <a href="" class="numstyle1" href="${ctx }/caninterviewresumes?pageNum=${resumereceived.totalPageNum}&type=1"><font color="#fff">尾页</font></a>
		            </div>
