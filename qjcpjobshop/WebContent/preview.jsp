...
<title>简历预览-我的简历-奇迹才聘网-最专业的互联网招聘平台</title>
<meta content="23635710066417756375" property="qc:admins">
<meta name="description" content="奇迹才聘网是互联网领域垂直招聘网站,互联网职业机会尽在奇迹才聘网">
<meta name="keywords" content="奇迹才聘,奇迹才聘网,奇迹才聘招聘,奇迹才聘, 奇迹才聘网 ,互联网招聘,奇迹才聘互联网招聘, 移动互联网招聘, 垂直互联网招聘, 微信招聘, 微博招聘, 奇迹才聘官网, 奇迹才聘百科,跳槽, 高薪职位, 互联网圈子, IT招聘, 职场招聘, 猎头招聘,O2O招聘, LBS招聘, 社交招聘, 校园招聘, 校招,社会招聘,社招">
  	...
  	<div id="previewWrapper">
        ...
        <div class="preview_content">
            <div class="profile_box" id="basicInfo">
                ...
                <div class="basicShow">
                   <span>${resume.name } | 
                    ${resume.sex } |                     ${resume.topDegree } |                                       		3年工作经验
            		            			| ${resume.expectCity }<br>
            			            				${resume.positionName } · ${resume.companyName } | ${resume.degree } · ${resume.schoolName }<br>
...
<!--                     	<img width="120" height="120" alt="jason" src="style/images/default_headpic.png"> -->
	                ...
	                <div class="projectShow">
	                  <ul class="plist clearfix">
		            					...
		            					<div class="f16 mb10">${resume.projectName }，jason
		            						<span class="c9">
		            									            								（${resume.projectYearStart }.${resume.projectMonthStart }-${resume.projectYearEnd }.${resume.projectMonthEnd }）
		            									            						</span>
		            					</div>
		            							            					<div class="dl1"></div>
		            							            				</div>
