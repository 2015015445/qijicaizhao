...
<script type="${ctx}/text/javascript" src="style/js/jquery.lib.min.js"></script>
<script type="${ctx}/text/javascript" src="style/js/core.min.js"></script>
	...
	<div class="login_wrapper">
		...
		<div class="login_box">
        	<form id="loginForm" method="post" action="${ctx}/user/regist">
            	...
            	<input type="text" id="email" name="findJobEmail" tabindex="1" placeholder="请输入常用邮箱地址" />
