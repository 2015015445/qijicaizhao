...
<title>我的投递记录-招聘服务-奇迹才聘网-最专业的互联网招聘平台</title>
        ...
        <div class="clearfix">
            	...
            	<dl class="c_delivery">
                    ...
                    <dd>
                    	<div class="delivery_tabs">
                    		<ul class="reset">
                    			<c:if test="${resumereceived.list[loop.count-1].type == 5}">
                            ...
                            <ul class="reset my_delivery">
                            	...
                            	<c:forEach items="${position }" var="p" varStatus="loop">
                            		<li>
                             		<div class="d_item">
                             			<h2 title="${p.name }">
	                                    <a target="_blank" href="http://www.lagou.com/jobs/149594.html">
	                                    <em>${p.name }</em> 
	                                    <span>（${p.minSalary }k-${p.maxSalary }k）</span>
	                                    <!--  -->
	                                    </a>
	                                    </h2>
	                                    <div class="clear"></div>
	                                    ...
	                                    <c:if test="${resumereceived.list[loop.count-1].type == 0 }">
	                                    	<a class="btn_showprogress" href="javascript:;">已发送<i></i></a>
	                                    </c:if>
	                                    <c:if test="${resumereceived.list[loop.count-1].type == 1 }">
	                                    	<a class="btn_showprogress" href="javascript:;">待沟通<i></i></a>
	                                    </c:if>
	                                    <c:if test="${resumereceived.list[loop.count-1].type == 2 }">
	                                    	<a class="btn_showprogress" href="javascript:;">通知面试<i></i></a>
	                                    </c:if>
	                                    <c:if test="${resumereceived.list[loop.count-1].type == 3 }">
            ...
            <div class="content_r">
            	<div class="mycenterR" id="myInfo">
                	...
                	<img width="242" height="242" alt="奇迹才聘微信公众号二维码" src="style/images/qr_delivery.png">
