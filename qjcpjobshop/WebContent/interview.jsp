	...
	<dd>
            ...
            <div class="content">
            	<dl class="company_center_content">
                    <dt>
                        <h1>
                            <em></em>
                            	已通知面试简历  <span>（共${resumereceived.totalCount }份）</span>                        </h1>
                    </dt>
                    <dd>
     ...
     <input type="hidden" value="" name="positionId" id="positionId">
		                        		...
		                        		<li data-id="1686182" class="onlineResume">
			                                ...
			                                <div class="resumeIntro">
			                                    ...
			                                    <div class="links">
			                                        ...
			                                        <a data-deliverid="1686182" class="resume_refuse" href="${ctx }/updateresumerecivedtype?id=${resumereceived.list[loop.count-1].id}&agotype=2&type=3">不合适</a>
			        ...
			        <c:if test="${resumereceived.totalPageNum < 5}">
			        	...
			        	<a class="numstyle1" href="${ctx }/caninterviewresumes?pagenum=${num}&type=2"><font color="#fff">${num }</font></a>
			        	</c:forEach>
			        </c:if>
			        <c:if test="${resumereceived.totalPageNum > 5}">
