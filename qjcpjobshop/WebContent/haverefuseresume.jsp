...
<dl class="company_center_aside">
	...
	<dd>
     ...
     <input type="hidden" value="" name="positionId" id="positionId">
			        ...
			        <a href="" class="numstyle1" href="${ctx }/caninterviewresumes?pageNum=1&type=3"><font color="#fff">首页</font></a>
			        ...
			        <a href="" class="numstyle1" href="${ctx }/caninterviewresumes?pageNum=${resumereceived.totalPageNum}&type=3"><font color="#fff">尾页</font></a>
		            </div>
