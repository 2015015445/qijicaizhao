...
<dl class="company_center_aside">
	...
	<dd>
     ...
     <input type="hidden" value="" name="positionId" id="positionId">
			        ...
			        <a class="numstyle1" href="${ctx }/caninterviewresumes?pageNum=1&type=0"><font color="#fff">首页</font></a>
			        ...
			        <a class="numstyle1" href="${ctx }/caninterviewresumes?pageNum=${resumereceived.totalPageNum}&type=0"><font color="#fff">尾页</font></a>
		            </div>
