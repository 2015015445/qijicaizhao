...
<dl class="company_center_aside">
	...
	<dd>
     ...
     <input type="hidden" value="" name="positionId" id="positionId">
		                        	...
		                        	<c:forEach items="${resume }" var="p" varStatus="loop">
		                        		<li data-id="1686182" class="onlineResume">
			                                ...
			                                <div class="resumeShow">
			                                	<a title="预览在线简历" target="_blank" class="resumeImg" href="preview?email=${p.email}">
			        ...
			        <a href="" class="numstyle1" href="${ctx }/caninterviewresumes?pageNum=1&type=0"><font color="#fff">首页</font></a>
			        <a class="numstyle1" href="${ctx }/caninterviewresumes?pageNum=${resumereceived.prePageNum}&type=0" ><font color="#fff">上一页</font></a>
			        <c:if test="${resumereceived.totalPageNum < 5}">
			        	<c:forEach  begin="1" end="${resumereceived.totalPageNum }" var="num">
			        	<a class="numstyle1" href="${ctx }/caninterviewresumes?pageNum=${num}&type=0"><font color="#fff">${num }</font></a>
			        	</c:forEach>
			        </c:if>
			        <c:if test="${resumereceived.totalPageNum > 5}">
			        ...
			        <a class="numstyle1" href="${ctx }/caninterviewresumes?pageNum=${resumereceived.nextPageNum}&type=0" ><font color="#fff">下一页</font></a>
			        <a href="" class="numstyle1" href="${ctx }/caninterviewresumes?pageNum=${resumereceived.totalPageNum}&type=0"><font color="#fff">尾页</font></a>
		            </div>
