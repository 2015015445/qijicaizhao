            ...
            <div class="content">
            	<dl class="company_center_content">
                    ...
                    <dd>
                    	...
                    	<form action="${ctx}/position/addposition1" method="post" id="jobForm">
                            	...
                            	<tr>
                                	...
                                	<td>
                                    	<div class="salary_range">
                                            <div>
                                                <input type="text" placeholder="最低月薪" value="" id="salaryMin" name="minSalary"> 
                                                <span>k</span>
                                            </div>
                                            <div>
                                                <input type="text" placeholder="最高月薪" value="" id="salaryMax" name="maxSalary"> 
                                                <span>k</span>
                                            </div>
                            ...
                            <table class="btm">
                            	<tbody><tr>
                                	...
                                	<td width="85">职位诱惑</td>
                                	<td>
                                    	<input type="text" placeholder="20字描述该职位的吸引力，如：福利待遇、发展前景等" value="" name="tempation" class="input_520" id="positionAdvantage">
                                    </td>
                                </tr>
                            	<tr>
                                	<td><span class="redstar">*</span></td>
                            ...
                            <table>
                            	<tbody><tr>
                                	...
                                	<td colspan="2">
                                        ...
                                        <input type="hidden" value="admin@admin.com" id="receiveEmail" name="receiveemail">
                                    </td>
                                </tr>
                                <tr>
                                	<td width="25"></td>
                                ...
                                <tr>
                                	...
                                	<td colspan="2">
                                    	...
                                    	<input type="submit" value="发布" id="" class="btn_32">
                                    </td>
                                </tr>
                         	</tbody></table>
                        </form>
...
$('#select_category').click(function(){
		...
		$.getScript("${ctx}/style/js/jobtype.js");  //加载js文件
		$.getScript("${ctx}/style/js/jobtype.js",function(){  //加载test.js,成功后，并执行回调函数
		  console.log("加载js文件");
		});
})
