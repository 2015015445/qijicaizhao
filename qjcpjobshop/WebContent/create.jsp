...
<dl class="company_center_aside">
		<dt>我发布的职位</dt>
			<dd>
		<a href="${ctx}/position/findposition?size=1&id=${id}">有效职位</a>
	</dd>
	<dd>
		<a href="${ctx}/position/findposition?size=0&id=${id}">已下线职位</a>
	</dd>
	</dl>
                            ...
                            <table class="btm">
                            	...
                            	<tr>
                                	...
                                	<td>
                                        ...
                                        <textarea name="description" id="positionDetail" class="tinymce" aria-hidden="true"></textarea>
                                    </td>
                                </tr>
                                <tr>
                                	<td><span class="redstar">*</span></td>
